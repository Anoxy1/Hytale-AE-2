 ...
 * ME Cable BlockState
 *
 * Transport block that connects ME network devices. Uses connection bitmask for
 * dynamic visual states (like HyPipes).
 *
 * Connection bits (0-63): - Bit 0: Down - Bit 1: Up - Bit 2: North - Bit 3:
 * South - Bit 4: West - Bit 5: East
 */
